...
@section('page_action')
    <a href="{{ route('categories.index') }}" class="btn btn-info">All Categories</a>
@stop
                                ...
                                <div class="form-group">
                                    ...
                                    <select name="parent_category" id="parent_category"  class="form-control {{ $errors->has('parent_category') ? ' is-invalid' : '' }}">
                                        ...
                                        @foreach($categories as $category)
                                            <option value="{{ $category->id }}" @if(old('parent_category') == $category->id) selected @endif>{{ $category->name }}</option>
                                        @endforeach
                                    </select>
