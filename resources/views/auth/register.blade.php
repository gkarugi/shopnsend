...
@section('content')
    <form class="card" action="{{ route('register') }}" method="post">
        ...
        <div class="card-body p-6">
            <div class="card-title">Create your new account</div>

            <div class="form-group">
                <label for="name" class="form-label">Email address</label>
                <input type="text" class="form-control {{ $errors->has('name') ? ' is-invalid' : '' }}" id="name" name="name" value="{{ old('name') }}" aria-describedby="name" placeholder="Enter name" required autofocus>
                @if ($errors->has('name'))
